...
class VideoResNet(nn.Module):
    ...
    def forward(self, x):
        x_0 = self.stem(x)    # [1,64,256,256]
        x_1 = self.layer1(x_0)  # [1,64,256,256]
        x_2 = self.layer2(x_1)   # [1,128,128,128]
        x_3 = self.layer3(x_2)   # [1,256,64,64]
        x_4 = self.layer4(x_3)   # [1,512,512,512]
